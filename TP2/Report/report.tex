...
\begin{itemize}
 ...
 \item Quinta coluna $\Rightarrow$ Tag relativa à informação da Palavra
\end{itemize}

Apesar de não ser utilizada diretamente, a sexta coluna é também importante, pois é nesta que está contida a informação relacionada com a Tag apresentada na quinta coluna.
...
\begin{enumerate}
	\item Palavra $\Rightarrow$ Dumbledore ; Lema $\Rightarrow$ dumbledore ; Tag $\Rightarrow$ NP ; Informação $\Rightarrow$ Noun Proper ;
	\item Palavra $\Rightarrow$ voltou ; Lema $\Rightarrow$ voltar ; Tag $\Rightarrow$ VMI ; Informação $\Rightarrow$ Verb Main Indicative ;
	\item Palavra $\Rightarrow$ se ; Lema $\Rightarrow$ se ; Tag $\Rightarrow$ PP ; Informação $\Rightarrow$ Pronoun Personal ;
	\item Palavra $\Rightarrow$ e ; Lema $\Rightarrow$ e ; Tag $\Rightarrow$ CC ; Informação $\Rightarrow$ Conjunction Coordinating ;
	\item Palavra $\Rightarrow$ desceu ; Lema $\Rightarrow$ descer ; Tag $\Rightarrow$ VMI ; Informação $\Rightarrow$ Verb Main Indicative ;
	\item Palavra $\Rightarrow$ a ; Lema $\Rightarrow$ o ; Tag $\Rightarrow$ DA ; Informação $\Rightarrow$ Determiner Article ;
	\item Palavra $\Rightarrow$ rua ; Lema $\Rightarrow$ rua ; Tag $\Rightarrow$ NC ; Informação $\Rightarrow$ Noun Common ;
	\item Palavra $\Rightarrow$ . ; Lema $\Rightarrow$ . ; Tag $\Rightarrow$ Fp ; Informação $\Rightarrow$ Punctuation Period ;
\end{enumerate}
