...
\chapter{Lista de Citações}
\label{sec:primeiro_filtro}


\newpage

\chapter{Lista de Provérbios}
\label{sec:segundo_filtro}
...
\chapter{Lista de Provérbios Adulterados}
\label{sec:terceiro_filtro}
